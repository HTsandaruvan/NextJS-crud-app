                    ...
                    <CardContent>
                        <div className='flex flex-col space-y-5'>
                            <div className='flex flex-col space-y-1.5'>
                                ...
                                <Input id="name" name="name" placeholder="Jone Doe" className={`${error?.error && error?.message && error.message.includes("Name") ? "border-3 border-red-600" : ""}`}
                                />
                            </div>

                            <div className='flex flex-col space-y-1.5'>
                                <Label htmlFor="email">Email</Label>
                                <Input id="email" name="email" placeholder="name@example.com" className={`${error?.error && error?.message && error.message.includes("Email") ? "border-3 border-red-600" : ""}`} />
                            </div>

                            <div className='flex flex-col space-y-1.5'>
                                <Label htmlFor="password">Password</Label>
                                <Input type="password" id="password" name="password" placeholder="Enter new password" className={`${error?.error && error?.message && error.message.includes("Password") ? "border-3 border-red-600" : ""}`} />
                            </div>

                            <div className='flex flex-col space-y-1.5'>
                                <Label htmlFor="confirm-password">Confirm Password</Label>
                                <Input className={`${error?.error && error?.message && error.message.includes("Passwords do not match") ? "border-3 border-red-600" : ""}`} type="password" id="confirm-password" name="confirm-password" placeholder="Enter password again" />
                            </div>
